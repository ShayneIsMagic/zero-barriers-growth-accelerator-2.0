...
async function testQAExtraction() {
  ...
  console.log(
    'Testing Playwright (primary) -> Puppeteer (fallback) -> Fetch (final fallback)...\n'
  );
  ...
  console.log(
    '1. 🎭 Playwright (Primary): Best performance, cross-browser support'
  );
  console.log(
    '2. 🎪 Puppeteer (Fallback): Chrome automation if Playwright fails'
  );
