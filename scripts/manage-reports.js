...
async function listReports(options = {}) {
  try {
    ...
    paginatedReports.forEach((report, index) => {
      ...
      console.log(
        `   Score: ${report.summary.overallScore}/100 (${report.summary.rating})`
      );
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log(
        '  node scripts/manage-reports.js list --url=salesforceconsultants.io'
      );
      console.log(
        '  node scripts/manage-reports.js get salesforceconsultants-io-2024-01-15-143022'
      );
      console.log('  node scripts/manage-reports.js stats');
      break;
  }
