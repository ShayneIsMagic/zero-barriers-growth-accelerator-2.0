...
import { Copy, Download, History, Loader2, Plus, Save, Users } from 'lucide-react';
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle>B2C Elements of Value Analysis</CardTitle>
                    <CardDescription>30 B2C Elements framework analysis</CardDescription>
                  </div>
                ...
                {result.analysis && (
                  <div className="prose dark:prose-invert max-w-none">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-xl font-semibold">B2C Elements Analysis Results</h3>
