...
export const B2C_ELEMENTS = {
  ...
  categories: {
    ...
    emotional: {
      name: 'Emotional',
      description:
        'Value elements that create feelings and emotional connections',
      subcategories: [
        {
          name: 'Well-being',
          elements: [
      ...
      subcategories: [
        {
          ...
          elements: [
            ...
            },
            {
              ...
              description:
                'Helps organization get things done with less effort',
            },
            {
      ...
      subcategories: [
        {
          ...
          elements: [
            {
              name: 'achiever',
              keywords: ['achievement', 'accomplish', 'complete', 'finish'],
              description: 'Driven to achieve',
            },
            {
              name: 'arranger',
              keywords: ['organize', 'arrange', 'coordinate', 'manage'],
              description: 'Can arrange and orchestrate',
            },
            {
              name: 'belief',
              keywords: ['values', 'principles', 'ethics', 'morals'],
              description: 'Core values that are unchanging',
            },
            {
              name: 'consistency',
              keywords: ['fair', 'equal', 'consistent', 'balanced'],
              description: 'Balance and evenness',
            },
            {
              name: 'deliberative',
              keywords: ['careful', 'cautious', 'thoughtful', 'prudent'],
              description: 'Careful and vigilant',
            },
            {
              name: 'discipline',
              keywords: ['routine', 'structure', 'order', 'systematic'],
              description: 'Enjoy routine and structure',
            },
            {
              name: 'focus',
              keywords: ['prioritize', 'concentrate', 'direct', 'aim'],
              description: 'Can take direction and follow through',
            },
            {
              name: 'responsibility',
              keywords: ['accountable', 'dependable', 'reliable', 'committed'],
              description: 'Take psychological ownership',
            },
            {
              name: 'restorative',
              keywords: ['problem-solving', 'fix', 'repair', 'restore'],
              description: 'Adept at dealing with problems',
            },
          ],
        },
      ],
      ...
      subcategories: [
        {
          ...
          elements: [
            {
              name: 'activator',
              keywords: ['action', 'initiate', 'start', 'begin'],
              description: 'Can make things happen',
            },
            {
              name: 'command',
              keywords: ['lead', 'direct', 'control', 'manage'],
              description: 'Have presence and can take control',
            },
            {
              name: 'communication',
              keywords: ['explain', 'describe', 'present', 'articulate'],
              description: 'Generally find it easy to put thoughts into words',
            },
            {
              name: 'competition',
              keywords: ['compete', 'win', 'victory', 'success'],
              description: 'Measure progress against others',
            },
            {
              name: 'maximizer',
              keywords: ['excellence', 'strength', 'talent', 'potential'],
              description:
            ...
            {
              name: 'significance',
              keywords: ['important', 'meaningful', 'impact', 'influence'],
              description:
                'Want to be very important in the eyes of other people',
            },
            {
              name: 'woo',
              keywords: ['win', 'persuade', 'charm', 'influence'],
              description: 'Love the challenge of meeting new people',
            },
          ],
        },
      ],
      ...
      subcategories: [
        {
          ...
          elements: [
            {
              name: 'adaptability',
              keywords: ['flexible', 'adaptable', 'adjust', 'change'],
              description: 'Prefer to go with the flow',
            },
            {
              name: 'connectedness',
              keywords: ['connected', 'linked', 'related', 'unified'],
              description: 'Have faith in the links between all things',
            },
            {
              name: 'developer',
              keywords: ['develop', 'grow', 'improve', 'enhance'],
              description: 'Recognize and cultivate the potential in others',
            },
            {
              name: 'empathy',
              keywords: ['understand', 'feel', 'sense', 'perceive'],
              description: 'Can sense the feelings of other people',
            },
            {
              name: 'harmony',
              keywords: ['harmony', 'peace', 'agreement', 'consensus'],
              description: 'Look for consensus',
            },
            {
              name: 'includer',
              keywords: ['include', 'welcome', 'embrace', 'accept'],
              description: 'Accepting of others',
            },
            {
              name: 'individualization',
              keywords: ['unique', 'individual', 'personal', 'distinct'],
              description: 'Intrigued by the unique qualities of each person',
            },
            {
              name: 'positivity',
              keywords: ['positive', 'optimistic', 'cheerful', 'upbeat'],
              description: 'Have an enthusiasm that is contagious',
            },
            {
              name: 'relator',
              keywords: ['relationship', 'bond', 'connection', 'friendship'],
              description: 'Enjoy close relationships with others',
            },
          ],
        },
      ],
      ...
      subcategories: [
        {
          ...
          elements: [
            {
              name: 'analytical',
              keywords: ['analyze', 'examine', 'investigate', 'study'],
              description: 'Search for reasons and causes',
            },
            {
              name: 'context',
              keywords: ['context', 'background', 'history', 'perspective'],
              description: 'Enjoy thinking about the past',
            },
            {
              name: 'futuristic',
              keywords: ['future', 'vision', 'possibility', 'potential'],
              description: 'Inspired by the future and what could be',
            },
            {
              name: 'ideation',
              keywords: ['ideas', 'concepts', 'innovation', 'creativity'],
              description: 'Fascinated by ideas',
            },
            {
              name: 'input',
              keywords: ['collect', 'gather', 'accumulate', 'amass'],
              description: 'Have a craving to know more',
            },
            {
              name: 'intellection',
              keywords: ['intellectual', 'thinking', 'mental', 'cognitive'],
              description: 'Characterized by intellectual activity',
            },
            {
              name: 'learner',
              keywords: ['learn', 'study', 'acquire', 'master'],
              description:
                'Have a great desire to learn and continuously improve',
            },
            {
              name: 'strategic',
              keywords: ['strategy', 'plan', 'approach', 'method'],
              description: 'Create alternative ways to proceed',
            },
          ],
        },
      ],
