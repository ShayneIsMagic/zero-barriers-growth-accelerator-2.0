...
export class UnifiedLocalForageStorage {
  ...
  private static getAssessmentDisplayName(assessmentType?: string): string {
    const names: Record<string, string> = {
      ...
      'elements-value-b2c-standalone': 'B2C Elements of Value',
      'elements-value-b2b-standalone': 'B2B Elements of Value',
      'clifton-strengths': 'CliftonStrengths Analysis',
      'clifton-strengths-standalone': 'CliftonStrengths Analysis',
      'golden-circle': 'Golden Circle Analysis',
      'golden-circle-standalone': 'Golden Circle Analysis',
      'jambojon-archetypes': 'Jambojon Brand Archetypes',
      'brand-archetypes-standalone': 'Brand Archetypes Analysis',
      'google-tools': 'Google Tools Analysis',
      'automated-google-tools': 'Automated Google Tools',
      'elements-value-b2c-standalone-chunked': 'B2C Elements Chunked Report',
      'elements-value-b2c-standalone-unified': 'B2C Elements Unified Report',
      'elements-value-b2c-standalone-readable': 'B2C Elements Readable Report',
      'elements-value-b2b-standalone-chunked': 'B2B Elements Chunked Report',
      'elements-value-b2b-standalone-unified': 'B2B Elements Unified Report',
      'elements-value-b2b-standalone-readable': 'B2B Elements Readable Report',
      'clifton-strengths-standalone-chunked': 'CliftonStrengths Chunked Report',
      'clifton-strengths-standalone-unified': 'CliftonStrengths Unified Report',
      'clifton-strengths-standalone-readable': 'CliftonStrengths Readable Report',
      'golden-circle-standalone-chunked': 'Golden Circle Chunked Report',
      'golden-circle-standalone-unified': 'Golden Circle Unified Report',
      'golden-circle-standalone-readable': 'Golden Circle Readable Report',
      'brand-archetypes-standalone-chunked': 'Brand Archetypes Chunked Report',
      'brand-archetypes-standalone-unified': 'Brand Archetypes Unified Report',
      'brand-archetypes-standalone-readable': 'Brand Archetypes Readable Report',
      'revenue-trends-readable': 'Revenue Trends Readable Report',
      'google-tools-readable': 'Google Tools Readable Report',
      'automated-google-tools-readable': 'Automated Google Tools Readable Report',
    };
