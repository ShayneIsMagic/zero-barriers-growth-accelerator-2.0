 ...
 */
export async function generateB2CAnalysis(existing: any, proposed: any, url: string): Promise<string> {
 ...
 */
export async function generateB2BAnalysis(existing: any, proposed: any, url: string): Promise<string> {
  const model = genAI.getGenerativeModel({ model: 'gemini-2.5-flash' });
 ...
 */
export async function generateCliftonStrengthsAnalysis(existing: any, proposed: any, url: string): Promise<string> {
  const model = genAI.getGenerativeModel({ model: 'gemini-2.5-flash' });
 ...
 */
export async function generateGoldenCircleAnalysis(existing: any, proposed: any, url: string): Promise<string> {
  const model = genAI.getGenerativeModel({ model: 'gemini-2.5-flash' });
