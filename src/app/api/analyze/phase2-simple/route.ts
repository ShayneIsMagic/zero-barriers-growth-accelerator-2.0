...
export async function POST(request: NextRequest) {
  try {
    ...
    const [
      ...
      FocusedAnalysisService.analyzeFunctionalElements(
        'phase2-analysis',
        content,
        industry
      ),
      FocusedAnalysisService.analyzeStrategicThinking(
        'phase2-analysis',
        content,
        industry
      ),
      FocusedAnalysisService.analyzeTableStakes(
        'phase2-analysis',
        content,
        industry
      ),
    ...
    const results = {
      ...
      cliftonStrengths: {
        strategicThinking: strategicAnalysis.success
          ? strategicAnalysis.data
          : null,
        error: strategicAnalysis.error,
      },
      b2bElements: {
        tableStakes: tableStakesAnalysis.success
          ? tableStakesAnalysis.data
          : null,
