    ...
    <div className="mx-auto max-w-7xl space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate comprehensive research, recommendations, and strategic
            roadmap.
          </CardDescription>
        </CardHeader>
          ...
          <div className="flex gap-2">
            {phase1Data && (
              <div className="flex items-center gap-2 rounded-md border border-green-200 bg-green-50 p-2">
                ...
                <span className="text-sm text-green-700">Phase 1 ✓</span>
              </div>
            )}
            {phase2Data && (
              <div className="flex items-center gap-2 rounded-md border border-green-200 bg-green-50 p-2">
                <CheckCircle className="h-4 w-4 text-green-500" />
                <span className="text-sm text-green-700">Phase 2 ✓</span>
              </div>
            )}
          </div>
        </CardContent>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.executiveSummary.keyStrengths?.map(
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.executiveSummary.criticalGaps?.map(
                            (gap: string, i: number) => (
                              <li key={i} className="flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <div className="space-y-2">
                          {phase3Data.comprehensiveAnalysis.whatIsWorking.contentStrengths?.map(
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {phase3Data.comprehensiveAnalysis.whatIsWorking.technicalStrengths?.map(
                            (strength: any, i: number) => (
                              <div
                                key={i}
                                className="rounded-md border border-green-200 bg-green-50 p-3"
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <div className="space-y-2">
                          {phase3Data.comprehensiveAnalysis.whatIsNotWorking.contentGaps?.map(
                            (gap: any, i: number) => (
                              <div
                                key={i}
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {phase3Data.comprehensiveAnalysis.whatIsNotWorking.technicalIssues?.map(
                            (issue: any, i: number) => (
                              <div
                                key={i}
                                className="rounded-md border border-red-200 bg-red-50 p-3"
            ...
            <Card>
              ...
              <CardContent>
                {phase3Data.comprehensiveAnalysis?.recommendedChanges ? (
                  <div className="space-y-4">
                    {phase3Data.comprehensiveAnalysis.recommendedChanges.map(
                      (rec: any, i: number) => (
            ...
            <Card>
              ...
              <CardContent>
                {phase3Data.comprehensiveAnalysis?.quickWins ? (
                  <div className="space-y-4">
                    {phase3Data.comprehensiveAnalysis.quickWins.map(
                      (win: any, i: number) => (
                        <div
                          key={i}
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.implementationRoadmap.immediate?.map(
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.implementationRoadmap.shortTerm?.map(
                            (action: string, i: number) => (
                              <li key={i} className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.implementationRoadmap.mediumTerm?.map(
                            (action: string, i: number) => (
                              <li key={i} className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm">
                          {phase3Data.comprehensiveAnalysis.implementationRoadmap.longTerm?.map(
                            (action: string, i: number) => (
                              <li key={i} className="flex items-center gap-2">
