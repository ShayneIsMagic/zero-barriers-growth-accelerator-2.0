-- =====================================================
-- BRAND ANALYSIS LAYER FOR SUPABASE - WORKING VERSION
-- Based on actual golden_circle_analyses table structure
-- =====================================================
...
-- Simplicity Patterns
INSERT INTO brand_patterns (theme_id, pattern_type, pattern_text, pattern_weight) VALUES
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'exact', 'simple', 0.95),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'exact', 'easy', 0.90),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'exact', 'effortless', 0.85),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'phrase', 'user-friendly', 0.90),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'phrase', 'intuitive', 0.85),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'phrase', 'streamlined', 0.85),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'semantic', 'no-hassle', 0.80),
((SELECT id FROM brand_theme_reference WHERE theme_name = 'Simplicity'), 'semantic', 'one-click', 0.85);
...
BEGIN
    ...
    RAISE NOTICE 'Brand Patterns: % / 35+', brand_patterns;
    RAISE NOTICE '';
    ...
    RAISE NOTICE '• golden_circle_analyses (added brand columns)';
    RAISE NOTICE '';
...
SELECT * FROM find_brand_patterns('We provide cutting-edge innovative solutions for trusted growth and success. Our breakthrough technology helps you achieve excellence with simple, easy-to-use tools.') LIMIT 8;
